...
enum GAME_STATE {
  ...
  PERCORRER_QUADRADO_3_STATE,  
  PERCORRER_OITO_STATE ,
  PERCORRER_CIRCUNFERENCIA_STATE
};
//Variaveis necessarias para a simulacao
...
enum ACTION {
  ...
  A_LEVAR_BOLA = 213, A_GIRAR_PARA_FRENTE = 214,
  ...
  PERCORRER_QUADRADO = 503, PERCORRER_QUADRADO_2 = 504, PERCORRER_QUADRADO_3 = 505, PERCORRER_OITO = 506, PERCORRER_CIRCUNFERENCIA = 507
};
