...
std::string getFoulNameById(VSSRef::Foul foul)
{
  switch (foul)
  {
...
std::string getTeamColorNameById(VSSRef::Color color)
{
  switch (color)
  {
  ...
  case VSSRef::Color::YELLOW:
    return "YELLOW";
  default:
    return "COLOR NOT IDENTIFIED";
  }
}

std::string getQuadrantNameById(VSSRef::Quadrant quadrant)
{
  switch (quadrant)
  {
  ...
  case VSSRef::Quadrant::QUADRANT_4:
    return "QUADRANT 4";
  default:
    return "QUADRANT NOT IDENTIFIED";
  }
}

std::string getHalfNameById(VSSRef::Half half)
{
  switch (half)
  {
  case VSSRef::Half::NO_HALF:
    return "NO_HALF";
  case VSSRef::Half::FIRST_HALF:
    return "FIRST HALF";
  case VSSRef::Half::SECOND_HALF:
    return "SECOND HALF";
  default:
    return "NO HALF DEFINED";
  }
}
