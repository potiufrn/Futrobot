...
static const double DIST_CHUTE(ROBOT_RADIUS+BALL_RADIUS-0.075-0.018);//SOMAR + 0.05 (GAMBIARRA LARC 2016)
...
static const unsigned GOLEIRO_DEFAULT(2);
    ...
    */
	...
	if (sem_bola_atras_da_bola) {
	  ...
	  else
	  {
	    ...
	    if (dist_sem < 2.0*dist_com ){ //|| dist_sem < 4*ROBOT_RADIUS tiramos para o jogo das oitavas
	      papeis.me[id_sem].funcao = COM_BOLA;
	      papeis.me[id_com].funcao = SEM_BOLA;
	    }
	  }
